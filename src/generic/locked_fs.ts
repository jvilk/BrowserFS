...
export default class LockedFS<T extends FileSystem> implements FileSystem {
  ...
  public rename(oldPath: string, newPath: string, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.rename(oldPath, newPath, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public renameSync(oldPath: string, newPath: string, uid: number, gid: number): void {
    ...
    return this._fs.renameSync(oldPath, newPath, uid, gid);
  }

  public stat(p: string, isLstat: boolean, uid: number, gid: number, cb: BFSCallback<Stats>): void {
    this._mu.lock(() => {
      this._fs.stat(p, isLstat, uid, gid, (err?: ApiError, stat?: Stats) => {
        this._mu.unlock();
        cb(err, stat);
      });
    });
  ...
  public openSync(p: string, flag: FileFlag, mode: number, uid: number, gid: number): File {
    ...
    return this._fs.openSync(p, flag, mode, uid, gid);
  }

  public unlink(p: string, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.unlink(p, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public unlinkSync(p: string, uid: number, gid: number): void {
    ...
    return this._fs.unlinkSync(p, uid, gid);
  }

  public rmdir(p: string, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.rmdir(p, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public mkdirSync(p: string, mode: number, uid: number, gid: number): void {
    ...
    return this._fs.mkdirSync(p, mode, uid, gid);
  }

  public readdir(p: string, uid: number, gid: number, cb: BFSCallback<string[]>): void {
    this._mu.lock(() => {
      this._fs.readdir(p, uid, gid, (err?: ApiError, files?: string[]) => {
        this._mu.unlock();
        cb(err, files);
      });
    });
  ...
  public readdirSync(p: string, uid: number, gid: number): string[] {
    ...
    return this._fs.readdirSync(p, uid, gid);
  }

  public exists(p: string, uid: number, gid: number, cb: (exists: boolean) => void): void {
    this._mu.lock(() => {
      this._fs.exists(p, uid, gid, (exists: boolean) => {
        this._mu.unlock();
        cb(exists);
      });
    });
  ...
  public existsSync(p: string, uid: number, gid: number): boolean {
    ...
    return this._fs.existsSync(p, uid, gid);
  }

  public realpath(p: string, cache: {[path: string]: string}, uid: number, gid: number, cb: BFSCallback<string>): void {
    this._mu.lock(() => {
      this._fs.realpath(p, cache, uid, gid, (err?: ApiError, resolvedPath?: string) => {
        this._mu.unlock();
        cb(err, resolvedPath);
      });
    });
  ...
  public realpathSync(p: string, cache: {[path: string]: string}, uid: number, gid: number): string {
    ...
    return this._fs.realpathSync(p, cache, uid, gid);
  }

  public truncate(p: string, len: number, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.truncate(p, len, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public readFileSync(fname: string, encoding: string, flag: FileFlag, uid: number, gid: number): any {
    ...
    return this._fs.readFileSync(fname, encoding, flag, uid, gid);
  }
  ...
  public writeFile(fname: string, data: any, encoding: string, flag: FileFlag, mode: number, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.writeFile(fname, data, encoding, flag, mode, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public writeFileSync(fname: string, data: any, encoding: string, flag: FileFlag, mode: number, uid: number, gid: number): void {
    if (this._mu.isLocked()) {
      throw new Error('invalid sync call');
    }
    return this._fs.writeFileSync(fname, data, encoding, flag, mode, uid, gid);
  }
  ...
  public appendFile(fname: string, data: any, encoding: string, flag: FileFlag, mode: number, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.appendFile(fname, data, encoding, flag, mode, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public appendFileSync(fname: string, data: any, encoding: string, flag: FileFlag, mode: number, uid: number, gid: number): void {
    if (this._mu.isLocked()) {
      throw new Error('invalid sync call');
    }
    return this._fs.appendFileSync(fname, data, encoding, flag, mode, uid, gid);
  }

  public chmod(p: string, isLchmod: boolean, mode: number, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.chmod(p, isLchmod, mode, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public chownSync(p: string, isLchown: boolean, new_uid: number, new_gid: number, uid: number, gid: number): void {
    ...
    return this._fs.chownSync(p, isLchown, new_uid, new_gid, uid, gid);
  }

  public utimes(p: string, atime: Date, mtime: Date, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.utimes(p, atime, mtime, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public utimesSync(p: string, atime: Date, mtime: Date, uid: number, gid: number): void {
    ...
    return this._fs.utimesSync(p, atime, mtime, uid, gid);
  }

  public link(srcpath: string, dstpath: string, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.link(srcpath, dstpath, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public linkSync(srcpath: string, dstpath: string, uid: number, gid: number): void {
    ...
    return this._fs.linkSync(srcpath, dstpath, uid, gid);
  }

  public symlink(srcpath: string, dstpath: string, type: string, uid: number, gid: number, cb: BFSOneArgCallback): void {
    this._mu.lock(() => {
      this._fs.symlink(srcpath, dstpath, type, uid, gid, (err?: ApiError) => {
        this._mu.unlock();
        cb(err);
      });
    });
  ...
  public symlinkSync(srcpath: string, dstpath: string, type: string, uid: number, gid: number): void {
    ...
    return this._fs.symlinkSync(srcpath, dstpath, type, uid, gid);
  }

  public readlink(p: string, uid: number, gid: number, cb: BFSCallback<string>): void {
    this._mu.lock(() => {
      this._fs.readlink(p, uid, gid, (err?: ApiError, linkString?: string) => {
        this._mu.unlock();
        cb(err, linkString);
      });
    });
  ...
  public readlinkSync(p: string, uid: number, gid: number): string {
    ...
    return this._fs.readlinkSync(p, uid, gid);
  }
}
