...
declare class fs {
    ...
    static open(path: string, flag: string, cb?: (err: ApiError, fd?: file.File) => any): void;
    static open(path: string, flag: string, mode: string, cb?: (err: ApiError, fd?: file.File) => any): void;
    static open(path: string, flag: string, mode: number, cb?: (err: ApiError, fd?: file.File) => any): void;
    ...
    static fstat(fd: file.File, cb?: (err: ApiError, stats?: Stats) => any): void;
    static fstatSync(fd: file.File): Stats;
    ...
    static write(fd: file.File, buffer: NodeBuffer, offset: number, length: number, cb?: (err: ApiError, written?: number, buffer?: NodeBuffer) => any): void;
    static write(fd: file.File, buffer: NodeBuffer, offset: number, length: number, position?: number, cb?: (err: ApiError, written?: number, buffer?: NodeBuffer) => any): void;
    static write(fd: file.File, data: string, cb?: (err: ApiError, written?: number, buffer?: NodeBuffer) => any): void;
    static write(fd: file.File, data: string, position: number, cb?: (err: ApiError, written?: number, buffer?: NodeBuffer) => any): void;
    static write(fd: file.File, data: string, position: number, encoding: string, cb?: (err: ApiError, written?: number, buffer?: NodeBuffer) => any): void;
    ...
    static read(fd: file.File, length: number, position: number, encoding: string, cb?: (err: ApiError, data?: string, bytesRead?: number) => void): void;
    static read(fd: file.File, buffer: NodeBuffer, offset: number, length: number, position: number, cb?: (err: ApiError, bytesRead?: number, buffer?: NodeBuffer) => void): void;
